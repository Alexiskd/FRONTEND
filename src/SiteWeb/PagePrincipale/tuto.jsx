...
const Button = styled.button`
  ...
  &:hover {
    background-color: ${props => props.disabled ? '#D1D5DB' : '#034e2e'};
  }
`;
...
const Indicators = styled.div`
  ...
  span {
    ...
    border-radius: 9999px;
    transition: background-color 0.3s;
    background-color: ${props => props.active ? '#025920' : 'rgba(2, 89, 32, 0.4)'};
  }
`;
...
const TutorialPopup = ({ onClose }) => {
  ...
  return (
    <Overlay>
      ...
      >
        <CloseButton onClick={onClose} aria-label="Fermer">&times;</CloseButton>
        ...
        <ButtonContainer>
          <Button onClick={prevSlide} disabled={currentSlide === 0}>Précédent</Button>
